    ...
    <main className='w-full min-h-screen bg-[#FFFFFF] flex flex-col items-center justify-center py-6 xl:py-16'>
      <div className="mx-auto w-[90%] xl:w-full xl:max-w-[720px] max-w-[360px] flex flex-col items-center justify-center xl:gap-y-12 gap-y-8">
        ...
        <div className="flex items-center justify-center flex-col w-full gap-y-1 xl:gap-y-2">
          ...
          <p className="font-normal text-sm text-black xl:text-base">
            Already have an account? <span className="text-[#E8730C]"><a href="/sign-in">Sign in</a></span>
          </p>
        </div>
        ...
        <div className="w-[90%] max-w-[354px] flex flex-col items-center justify-center mx-auto mb-10 xl:max-w-[840px]">
          <div className="flex flex-col max-w-[840px] mx-auto xl:gap-y-8 gap-y-4">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 w-full">
              ...
              <div className="relative w-full">
                ...
                <input type="tel" name="phone_number" placeholder="Phone number" className="mt-2 text-sm border border-[#828282] outline-none focus:border-[#fdae5c] hover:border-[#fdae5c] rounded-xl w-full h-[55px] px-6 py-[18px] md:text-base md:rounded-2xl md:h-[65px]" />
              </div>

              <div className="relative w-full">
                <label className="text-black text-sm leading-5 font-normal md:text-base">Password</label>
                <input type="password" name="password" placeholder="Password" className="mt-2 text-sm border outline-none focus:border-[#fdae5c] hover:border-[#fdae5c] border-[#828282] rounded-xl w-full h-[55px] px-6 py-[18px] md:text-base md:rounded-2xl md:h-[65px]" />
                <div className="mt-1">
              ...
              <div className="relative w-full">
                ...
                <input type="password" name="confirm_password" placeholder="Confirm Password" className="mt-2 text-sm border outline-none focus:border-[#fdae5c] hover:border-[#fdae5c] border-[#828282] rounded-xl w-full h-[55px] px-6 py-[18px] md:text-base md:rounded-2xl md:h-[65px]" />
                <div className="mt-1">
                  <p className="text-sm font-normal leading-5 text-red-500 md:text-base"></p>
                  <div className="py-1 transition_0_5s bg-[#27AE60] mt-3 rounded-xl" style={{width: '0%'}}></div>
                </div>
          ...
          <div className="relative w-full mt-4 xl:mt-8">
            ...
            <input type="text" name="referrer_id" placeholder="Enter referral ID" className="mt-2 text-sm border outline-none focus:border-[#fdae5c] hover:border-[#fdae5c] border-[#828282] rounded-xl w-full h-[55px] px-6 py-[18px] md:text-base md:rounded-2xl md:h-[65px]" />
            <div className="mt-1">
              <p className="text-sm font-normal leading-5 text-red-500 md:text-base"></p>
              <div className="py-1 transition_0_5s bg-[#27AE60] mt-3 rounded-xl" style={{width: '0%'}}></div>
            </div>
          ...
          <div className="w-full items-center place-content-center flex space-x-3">
            <input type="checkbox" name="i_agree" id="i_agree" />
            <p className="font-normal text-sm text-black md:text-base"> I agree to Velox <a className="text-blue-500" href="/terms-and-conditions">Terms and Conditions</a> and <a className="text-blue-500" href="/privacy-policy">Privacy policy</a></p>
          </div>

          <button type="submit" className="mt-4 xl:mt-6 h-[55px] xl:h-[77px] bg-[#E0E0E0] hover:bg-[#E8730C] rounded-xl text-white font-medium text-base leading-9 w-[80%] md:rounded-2xl md:text-2xl" onClick={() => router.push('/dashboard')}>Sign up</button>
        </div>
      </div>
    </main>
  );
